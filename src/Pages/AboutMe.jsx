      ...
      <div className="md:px-[10%] px-[6%]" id="About">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-full flex flex-col justify-between">
            ...
            >
              My name is Mohammed Arshad, a student specializing in Computer
              Network Engineering with a focus on front-end web development. I
              have a strong determination to keep learning and honing my skills
              to achieve perfection. I always strive to find the best solutions
              in every project I work on and have a great interest in the field
